...
import site.kicey.strategies.rpc.peripherals.dispatching.RpcPeripheralJobDispatcherProviderProxy;
...
public class ProviderStarter {
  ...
  /**
   * The PeripheralJobDispatcher used as provider.
   */
  private final RpcPeripheralJobDispatcherProviderProxy peripheralJobDispatcherProviderProxy;
  /**
  ...
  protected ProviderStarter(LocalKernel kernel,
      ...
      RpcPeripheralJobDispatcherProviderProxy peripheralJobDispatcherProviderProxy,
      DubboConfiguration dubboConfiguration,
      @ActiveInAllModes Set<KernelExtension> extensions,
      @KernelExecutor ScheduledExecutorService kernelExecutor) {
    this.kernel = requireNonNull(kernel, "kernel");
    this.plantModelService = requireNonNull(plantModelService, "plantModelService");
    this.peripheralJobDispatcherProviderProxy = requireNonNull(peripheralJobDispatcherProviderProxy, "peripheralJobDispatcherProviderProxy");
  ...
  public void startKernel()
    ...
    ServiceConfig<RpcPeripheralJobDispatcher> serviceConfig = new ServiceConfig<>();
    serviceConfig.setInterface(RpcPeripheralJobDispatcher.class);
    serviceConfig.setRef(peripheralJobDispatcherProviderProxy);
