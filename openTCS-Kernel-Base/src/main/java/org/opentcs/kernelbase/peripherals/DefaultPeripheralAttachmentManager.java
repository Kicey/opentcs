 ...
 */
public class DefaultPeripheralAttachmentManager
    implements PeripheralAttachmentManager {

  /**
   * This class's logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(DefaultPeripheralAttachmentManager.class);
  /**
   ...
   */
  @Inject
  public DefaultPeripheralAttachmentManager(@Nonnull InternalPeripheralService peripheralService,
