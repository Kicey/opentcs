...
import static site.kicey.strategies.provider.dispatcher.dispatching.DefaultDispatcherConfiguration.ReroutingImpossibleStrategy.IGNORE_PATH_LOCKS;
import static site.kicey.strategies.provider.dispatcher.dispatching.DefaultDispatcherConfiguration.ReroutingImpossibleStrategy.PAUSE_AT_PATH_LOCK;
import static site.kicey.strategies.provider.dispatcher.dispatching.DefaultDispatcherConfiguration.ReroutingImpossibleStrategy.PAUSE_IMMEDIATELY;
...
import site.kicey.strategies.provider.dispatcher.dispatching.DefaultDispatcherConfiguration.ReroutingImpossibleStrategy;
import site.kicey.strategies.provider.dispatcher.dispatching.rerouting.ReroutingStrategy;
import site.kicey.strategies.provider.dispatcher.dispatching.rerouting.VehiclePositionResolver;
