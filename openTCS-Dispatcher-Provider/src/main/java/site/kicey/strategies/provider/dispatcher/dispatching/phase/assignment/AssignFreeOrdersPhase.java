 ...
 */
package site.kicey.strategies.provider.dispatcher.dispatching.phase.assignment;
...
import site.kicey.strategies.provider.dispatcher.dispatching.Phase;
import site.kicey.strategies.provider.dispatcher.dispatching.TransportOrderUtil;
import site.kicey.strategies.provider.dispatcher.dispatching.phase.AssignmentState;
import site.kicey.strategies.provider.dispatcher.dispatching.phase.CandidateFilterResult;
import site.kicey.strategies.provider.dispatcher.dispatching.phase.OrderFilterResult;
import site.kicey.strategies.provider.dispatcher.dispatching.phase.VehicleFilterResult;
...
import site.kicey.strategies.provider.dispatcher.dispatching.selection.orders.IsFreelyDispatchableToAnyVehicle;
import site.kicey.strategies.provider.dispatcher.dispatching.selection.vehicles.CompositeVehicleSelectionFilter;
import site.kicey.strategies.provider.dispatcher.dispatching.selection.vehicles.IsAvailableForAnyOrder;
