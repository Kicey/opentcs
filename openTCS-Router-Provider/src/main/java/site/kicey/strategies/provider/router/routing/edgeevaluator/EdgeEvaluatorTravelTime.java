 ...
 */
package site.kicey.strategies.provider.router.routing.edgeevaluator;

import static site.kicey.strategies.provider.router.routing.PointRouter.INFINITE_COSTS;
